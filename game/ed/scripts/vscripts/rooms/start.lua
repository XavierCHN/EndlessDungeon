...
Room.UniqueName = "DefaultStart"

Room.RoomType = RoomType.Start

Room.IsPlayable = true

Room.vTerrainNames = {"radiant_journey_normal_1"}
...
function Room:OnPrepare()
	--print "Creating standard start room"
	-- 开始房间，显示战斗提示信息吗？
	-- 还是不显示了
end

function Room:OnEnter()
	--print "Entering standard start room"
end
...
function Room:OnExit()
	--print "Exiting standard start room"
end
