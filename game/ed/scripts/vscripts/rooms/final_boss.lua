...
Room.UniqueName = "Standard.FinalBoss"
...
function Room:OnPrepare()
	--print "Creating standard final boss room"
	-- 开始房间，显示战斗提示信息吗？
	-- 还是不显示了
end

function Room:OnEnter()
	--print "Entering standard final boss room"
end
...
function Room:OnExit()
	--print "Exiting standard final boss room"
end
